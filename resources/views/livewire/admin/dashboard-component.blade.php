                                ...
                                <div class="card-body">
                                    <div class="d-flex">
                                        <div class="flex-grow-1">
                                            <p class="text-muted fw-medium">Total Lost Report</p>
                                            <h4 class="mb-0">{{ $lost_pets }}</h4>
                                        </div>
                        ...
                        <div class="col-md-4">
                            <div class="card mini-stats-wid pt-2 pb-2">
                                <div class="card-body">
                                    <div class="d-flex">
                                        <div class="flex-grow-1">
                                            <p class="text-muted fw-medium">Total Found Report</p>
                                            <h4 class="mb-0">{{ $found_pets }}</h4>
                                        </div>
                        ...
                        <div class="col-md-4">
                            <div class="card mini-stats-wid pt-2 pb-2">
                                <div class="card-body">
                                    <div class="d-flex">
                                        <div class="flex-grow-1">
                                            <p class="text-muted fw-medium">Total Contact Message</p>
