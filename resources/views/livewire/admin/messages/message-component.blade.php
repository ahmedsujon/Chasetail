                ...
                <div class="col-lg-12">
                    <div class="card">
                        <div class="card-header bg-white" style="border-bottom: 1px solid #e2e2e7;">
                            <h4 class="card-title" style="float: left;">All Contact Messages</h4>
                        </div>
                        <div class="card-body">
                            <div class="row mb-3">
                            ...
                            <div class="table-responsive">
                                <table class="table align-middle table-nowrap table-bordered mb-0">
                                    ...
                                    <tbody>
                                        ...
                                        @else
                                            <tr>
                                                <td colspan="7" class="text-center pt-5 pb-5">No messages found!</td>
                                            </tr>
                                        @endif
                                    </tbody>
                                </table>
                        ...
                        <div class="card-footer bg-transparent">
                            {{ $messages->links('livewire.pagination-links') }}
                        </div>
                    </div>
                </div>
            </div>
...
@push('scripts')
    <script>
        window.addEventListener('message_deleted', event => {
