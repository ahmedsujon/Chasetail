            ...
            <div class="row">
                <div class="col-12">
                    <div class="page-title-box d-sm-flex align-items-center justify-content-between">
                        <h4 class="mb-sm-0 font-size-18">Found Pet Listing Report</h4>
                        <div class="page-title-right">
                            <ol class="breadcrumb m-0">
                                <li class="breadcrumb-item"><a href="{{ route('admin.dashboard') }}">Dashboard</a></li>
                                <li class="breadcrumb-item active">Found Pet Listing Report</li>
                            </ol>
                        </div>
                    </div>
                </div>
                ...
                <div class="col-lg-12">
                    <div class="card">
                        <div class="card-header bg-white" style="border-bottom: 1px solid #e2e2e7;">
                            <h4 class="card-title" style="float: left;">All Found Pet Listing Report</h4>
                        </div>
                        <div class="card-body">
                            <div class="row mb-3">
                                        ...
                                        @if ($reports->count() > 0)
                                            ...
                                            @foreach ($reports as $report)
                                                <tr>
                                                    ...
                                                    <td>
                                                        <a target="_blank" href="{{ route('app.found.dogs.details', ['id' => $report->id]) }}">
                                                            {{ getListingByID($report->found_dog_id)->name }}
                                                        </a>
                                                    </td>
