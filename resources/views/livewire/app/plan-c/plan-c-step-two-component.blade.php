<div>
    ...
    <section class="step-content mb-5">
        <div class="container">
            <form class="form-step" wire:submit.prevent="planCStepThree">
                <div class="row">
                    <div class="col-md-12 col-lg-12 col-12">
                        <div class="step-page">
                            <div class="row">
                                    ...
                                    <div class="form-left-right">
                                        ...
                                        <div class="mb-4">
                                            ...
                                            <input type="text" wire:model.blur="marking" class="form-control"
                                                placeholder="Describe pets marking (20 characters max) (Optional)" maxlength="20">
                                            @error('marking')
                                                <span class="label-bot-validate">{{ $message }}</span>
                                            @enderror
                                        </div>
