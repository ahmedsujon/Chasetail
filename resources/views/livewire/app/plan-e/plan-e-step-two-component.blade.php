<div>
    ...
    <section class="step-content mb-5">
        <div class="container">
            <form class="form-step" wire:submit.prevent="planEStepThree">
                <div class="row">
                    <div class="col-md-12 col-lg-12 col-12">
                        <div class="step-page">
                            <div class="row">
                                    ...
                                    <div class="form-left-right">
                                        <div class="mb-4">
                                            ...
                                            <textarea class="form-control" wire:model.blur="description" rows="3" maxlength="200"
                                                placeholder="ie. Pink collar, three legs, deaf, friendly, needs medicine (200 characters only)"></textarea>
                                            @error('description')
                                                <span class="label-bot-validate">{{ $message }}</span>
                                            @enderror
