<div>
            ...
            <div class="row">
                <div class="col-md-12 col-lg-12 col-12">
                    <div class="page-header-text">
                        <h4>Posting as Level Four Plan</h4>
    ...
    <section class="step-content">
        <div class="container">
            <form class="form-step" wire:submit.prevent="planEStepTwo">
                <div class="row">
                    <div class="col-md-12 col-lg-12 col-12">
                        <div class="step-page">
                            <h3>Add your pet photo</h3>
                            ...
                            <label for="images" class="drop-container" id="dropcontainer">
                                <span class="drop-title">Upload your pet photo</span>
