                                ...
                                <div class="col-md-12 col-lg-6 col-12">
                                    <div class="form-left-right">
                                        <div class="mb-4">
                                            ...
                                            <span class="label-bot-validate">Dog name is required</span>
                                        </div>
                                        <div class="mb-4" style="text-align: left;">
                                            ...
                                            <div class="btn-group" role="group"
                                                ...
                                                <input type="radio" wire:model.blur="gender" value="Male" class="btn-check" name="btnradio" id="Male"
                                                    autocomplete="off" checked>
                                                <label class="btn btn-outline-secondary btn-male"
                                                    for="Male">Male</label>

                                                <input type="radio" wire:model.blur="gender" value="Female" class="btn-check" name="btnradio" id="Female"
                                                    autocomplete="off">
                                                <label class="btn btn-outline-secondary btn-female"
                                                    for="Female">Female</label>

                                                <input type="radio" wire:model.blur="gender" value="Unknown" class="btn-check" name="btnradio" id="Unknown"
                                                    autocomplete="off">
                                ...
                                <div class="col-md-12 col-lg-6 col-12">
                                    <div class="form-left-right">
                                        ...
                                        <div class="mb-4">
                                            ...
                                            <span class="label-bot"><a href="#">Skip for now</a></span>
                                        </div>
                                    </div>
                                </div>
                            </div>
                                ...
                                <div class="col-lg-12 col-md-12 col-12">
                                    <div class="form-left-right">
                                        <div class="mb-4">
                                            ...
                                            <textarea class="form-control mt-4" wire:model.blur="description" rows="3" placeholder="Description ( 160 Words only )"></textarea>
                                        </div>
                                    </div>
                                </div>
                            </div>
